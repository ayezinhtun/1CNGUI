      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div>
          ...
          <p className="mt-8 text-secondary">
            CPU-Optimized Instances feature a 1:2 CPU-to-memory ratio, balancing
            high-performance processing with increased memory capacity. Powered
            by high-frequency CPUs and NVMe SSD storage.
          </p>
